...
const sections = [
  {
    ...
    title: (
      <>
        <span className="hidden lg:inline">Instruments Service</span>
        <span className="lg:hidden">Instruments</span>
      </>
    ),
  },
  { id: 'analytical-service', title: 'Analytical Service' },
  { id: 'valve-service', title: 'Valve Service' },
  { id: 'engineering-service', title: 'Engineering Service' },
  { id: 'system-support', title: 'System Support' },
]
